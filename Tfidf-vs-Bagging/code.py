...
X_test_tfodf = tfidf_vectorizer.transform(X_test)
# Code ends here
...
acc_tfidf_nb = accuracy_score(nb_2.predict(X_test_tfodf), Y_test)
...
acc_tfidf_logreg = accuracy_score(logreg_2.predict(X_test_tfodf), Y_test)
# display accuracies
